<%-- 
    Document   : trangmieng
    Created on : Sep 14, 2017, 10:16:59 AM
    Author     : LAPNV
--%>
...
<div class="container">
    <div id="breadcrumb">
        <ol class="breadcrumb container">
            ...
            <li><a href="trang-mieng.html"><span>Tráng miệng</span></a></li>
        </ol>
    </div>
    <div class="row">
                            ...
                            <div class="filter-right">
                                ...
                                <div class="sort">
                                    ...
                                    <select class="form-control" onchange="location = this.value;">
                                        <option value="http://atlantic.myzozo.net/trang-mieng?sort=p.sort_order&amp;order=ASC" selected="selected">Mặc định</option>

<%-- 
    Document   : combo
    Created on : Sep 14, 2017, 7:07:37 PM
    Author     : LAPNV
--%>
            ...
            <div id="content">
                ...
                <%--<c:forEach items="viewProduct" var="product">--%>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 image-container">
                                <div class="image">                                                                                
                                    <a href="" title="${viewProduct.productName}" class="imagezoom">
                                        <img itemprop="image" src="<%=request.getContextPath()%>/jsp/frontend/image/products/${viewProduct.images}" title="${viewProduct.productName}" alt="${viewProduct.productName}" id="image" data-zoom-image="" class="product-image-zoom img-responsive" style="width:395px;height: 420px;" />
                                    </a>
                                </div>
                                    ...
                                    <div class="image-additional slide carousel horical" id="image-additional">
                                        <div id="image-additional-carousel" class="carousel-inner">
                                            <div class="item clearfix">
                                                ...
                                                <a href="<%=request.getContextPath()%>/jsp/frontend/image/products/${viewProduct.images}" title="Combo" class="imagezoom" data-zoom-image="" data-image="<%=request.getContextPath()%>/jsp/frontend/image/products/${viewProduct.images}">
                                                    <img src="<%=request.getContextPath()%>/jsp/frontend/image/products/${viewProduct.images}" style="max-width:82px" title="Combo" alt="Combo" data-zoom-image="" class="product-image-zoom img-responsive" />
                                                </a>                                                              
                                                <a href="<%=request.getContextPath()%>/jsp/frontend/image/products/${viewProduct.images}" title="Combo" class="imagezoom" data-zoom-image="" data-image="<%=request.getContextPath()%>/jsp/frontend/image/products/${viewProduct.images}">
                                                    <img src="<%=request.getContextPath()%>/jsp/frontend/image/products/${viewProduct.images}" style="max-width:82px" title="Combo" alt="Combo" data-zoom-image="" class="product-image-zoom img-responsive" />
                                                </a>     
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 product-view">
                                <h1 class="title-product">${viewProduct.productName}</h1>
                                <div class="review">
                                    <div>

<%-- 
    ...
    Created on : Sep 14, 2017, 10:15:16 AM
    Author     : LAPNV
--%>
...
<div class="box productcarousel">
    ...
    <div class="box-content">
        ...
        <div class="carousel-controls">
            <a class="carousel-control fa fa-angle-left left" href="#productcarousel1833329064" data-slide="prev"></a>
            <a class="carousel-control fa fa-angle-right right" href="#productcarousel1833329064" data-slide="next"></a>
        </div>

        <div class="box-products slide carousel" id="productcarousel1833329064">
            <div class="carousel-inner">
                <div class="item active">
                    <div class="row products-row last">
                        <!-- 1 -->
                        <c:forEach items="${productHot}" var="p">
                                ...
                                <div class="product-block item-default" itemtype="" itemscope>
                                    <div class="image">
                                        ...
                                        <a class="img" href="<%=request.getContextPath()%>/viewPro.htm?productId=${p.productId}">
                                            <img src="<%=request.getContextPath()%>/jsp/frontend/image/products/${p.images}" alt="${p.productName}" class="img-responsive" style="width:177px;height:177px"/>
                                        </a>
                                        <!-- zoom image-->
